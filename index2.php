		    	...
		    	<div class="panel-body">
		        	<form method="POST" action="login.php">
		            	<fieldset>
		                	...
		                	<button type="submit" name="login" class="btn btn-lg btn-primary btn-block" style="background-color: #6c757d;" ><span class="glyphicon glyphicon-log-in"></span> Login</button>
		            	</fieldset>
		        	</form>
		    	</div>
		    </div>
